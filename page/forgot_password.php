...
<body>
    <div class="form-container">
        ...
        <p>
            Enter Your Mail Send Link Your Mail Please Check And Verify If Your Mail Before Account Create You Have A
            Link
            Inbox. Click Link & Your New Password
        </p>
        <form method="post">
            <div class="input-group">
                ...
                <input type="email" placeholder="Enter your email" id="reset-email" />
            </div>
            <button type="button" id="send-email-reset-btn">Send Reset Email</button>
        </form>
    </div>
</body>
